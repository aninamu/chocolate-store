...
os.environ.setdefault(
    "MONGODB_URL",
    "mongodb://127.0.0.1:27018/chocolate_store",
)
os.environ.setdefault("REDIS_URL", "redis://127.0.0.1:63790/0")


def _services_ports_open() -> bool:
    """Cheap reachability check without opening a MongoDB client."""
    for host, port in (("127.0.0.1", 27018), ("127.0.0.1", 63790)):
        try:
...
def api_client() -> Iterator[TestClient]:
    ...
    if not _services_ports_open():
        pytest.skip(
            "MongoDB (27018) / Redis (63790) not reachable; "
