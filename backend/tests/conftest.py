...
os.environ.setdefault("MONGODB_URL", "mongodb://127.0.0.1:57017")
os.environ.setdefault("MONGO_DB", "chocolate_store")
os.environ.setdefault("REDIS_URL", "redis://127.0.0.1:63790/0")


def _services_ports_open() -> bool:
    """Cheap reachability check without opening Mongo/Redis clients."""
